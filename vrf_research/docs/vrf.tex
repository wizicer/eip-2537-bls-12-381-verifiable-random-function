...
\begin{thebibliography}{10}
    ...
    \bibitem{DeepSafe} \href{https://github.com/deepsafe/whitepaper/blob/main/DeepSafe_A_Cryptography_Random_Verification_Layer.pdf}{DeepSafe: A Cryptography Random Verification Layer.}
\end{thebibliography}
